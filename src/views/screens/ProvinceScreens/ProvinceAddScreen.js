...
import { addProvince } from "../../../redux/actions/provincesActions";
import {
  CButton,
  CCard,
  CCardBody,
...
import {
  initialValues,
  validationSchema,
} from "./options/provinceValidationSchema";
...
function ProvinceAddScreen({ history }) {
  ...
  const addProvinceSelector = useSelector((state) => state.addProvince);
  const { loading, error, success } = addProvinceSelector;
  ...
  useEffect(() => {
    ...
    if (success) {
      dispatch(
        setSnackbar(true, "success", "Provincia insertado satisfactoriamente")
      );
    ...
    <CRow>
      <CCol xs="12">
        ...
        <CCard className="shadow">
          <CCardHeader>
            Formulario para Insertar <strong>Provincias</strong>
            <CButton
              variant="outline"
              color="light"
...
export default ProvinceAddScreen;
