...
import { Message, Loader } from "../../../../containers/utils";
...
function UserEditScreen({ history, match }) {
  ...
  initialValues.isProvinceSpecialist = user?.isProvinceSpecialist;
          ...
          <CCard className="shadow">
            ...
            <form onSubmit={formik.handleSubmit} className="m-3">
              <CCardBody>
                ...
                <CFormGroup row>
                  <CCol tag="label" sm="6" className="col-form-label">
                    ¿Es especialista de salud provincial?
                  </CCol>
                  <CCol xs="12" md="6">
                    <CSwitch
                      id="isFoodAndDrinkBoss"
                      name="isFoodAndDrinkBoss"
                      checked={formik.values.isProvinceSpecialist}
                      onChange={formik.handleChange}
                      className={"mx-1"}
                      variant={"3d"}
                      color={"primary"}
