...
export const personalListReducer = (state = {personal: []}, action) => {
    switch (action.type) {
        case OBJECT_LIST_REQUEST:
            return {loading: true};

        case OBJECT_LIST_SUCCESS:
            return {loading: false, personal: action.payload};
...
export const addPersonalReducer = (state = {}, action) => {
    switch (action.type) {
...
export const deletePersonalReducer = (state = {}, action) => {
    switch (action.type) {
...
export const personalDetailsReducers = (state = {personal: {}}, action) => {
    switch (action.type) {
...
export const editPersonalReducer = (state = {}, action) => {
    switch (action.type) {
