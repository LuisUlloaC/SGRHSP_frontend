...
export const clasificacionListReducer = (state = {clasificaciones: []}, action) => {
    switch (action.type) {
        case OBJECT_LIST_REQUEST:
            return {loading: true};

        case OBJECT_LIST_SUCCESS:
            return {loading: false, clasificaciones: action.payload};
...
export const addClasificacionReducer = (state = {}, action) => {
    switch (action.type) {
...
export const deleteClasificacionesReducer = (state = {}, action) => {
    switch (action.type) {
...
export const clasificacionDetailsReducers = (state = {clasificacion: {}}, action) => {
    switch (action.type) {
        case OBJECT_DETAILS_REQUEST:
            return {...state, loading: true};

        case OBJECT_DETAILS_SUCCESS:
            return {loading: false, clasificacion: action.payload};
...
export const editClasificacionReducer = (state = {}, action) => {
    switch (action.type) {
