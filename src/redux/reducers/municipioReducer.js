...
export const municipioListReducer = (state = {municipios: []}, action) => {
    switch (action.type) {
        case OBJECT_LIST_REQUEST:
            return {loading: true};

        case OBJECT_LIST_SUCCESS:
            return {loading: false, municipios: action.payload};
...
export const addMunicipioReducer = (state = {}, action) => {
    switch (action.type) {
...
export const deleteMunicipiosReducer = (state = {}, action) => {
    switch (action.type) {
...
export const municipioDetailsReducers = (state = {municipio: {}}, action) => {
    switch (action.type) {
        case OBJECT_DETAILS_REQUEST:
            return {...state, loading: true};

        case OBJECT_DETAILS_SUCCESS:
            return {loading: false, municipio: action.payload};
...
export const editMunicipioReducer = (state = {}, action) => {
    switch (action.type) {
