...
export const unidadListReducer = (state = {unidades: []}, action) => {
    switch (action.type) {
        case OBJECT_LIST_REQUEST:
            return {loading: true};

        case OBJECT_LIST_SUCCESS:
            return {loading: false, unidades: action.payload};
...
export const addUnidadReducer = (state = {}, action) => {
    switch (action.type) {
...
export const deleteUnidadesReducer = (state = {}, action) => {
    switch (action.type) {
...
export const unidadDetailsReducers = (state = {unidad: {}}, action) => {
    switch (action.type) {
...
export const editUnidadReducer = (state = {}, action) => {
    switch (action.type) {
